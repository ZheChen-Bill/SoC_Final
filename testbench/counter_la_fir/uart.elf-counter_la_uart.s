...
.Ltext0:
	...
	.file 0 "/home/ubuntu/SoC_Final2/SoC_Final/testbench/counter_la_fir" "counter_la_uart.c"
	.align	2
...
.LFB321:
	...
	nop
.L9:
	.loc 5 124 10 discriminator 1
	li	a5,637534208
	lw	a4,0(a5)
	.loc 5 124 43 discriminator 1
	li	a5,1
	beq	a4,a5,.L9
	.loc 5 128 60
	li	a5,-268423168
...
.LBB2:
	...
	j	.L10
.L11:
	.loc 5 170 40 discriminator 3
	lw	a0,-20(s0)
	call	check_input
	mv	a5,a0
	.loc 5 170 56 discriminator 3
	slli	a4,a5,16
	.loc 5 170 4 discriminator 3
	li	a5,637534208
	addi	a5,a5,12
	.loc 5 170 37 discriminator 3
	sw	a4,0(a5)
	.loc 5 169 21 discriminator 3
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L10:
	.loc 5 169 16 discriminator 1
	lw	a4,-20(s0)
	li	a5,63
	ble	a4,a5,.L11
.LBE2:
...
.LBB3:
	...
	j	.L12
.L13:
	.loc 5 202 40 discriminator 3
	lw	a0,-24(s0)
	call	check_output
	mv	a5,a0
	.loc 5 202 57 discriminator 3
	slli	a4,a5,16
	.loc 5 202 4 discriminator 3
	li	a5,637534208
	addi	a5,a5,12
	.loc 5 202 37 discriminator 3
	sw	a4,0(a5)
	.loc 5 201 21 discriminator 3
	lw	a5,-24(s0)
	addi	a5,a5,1
	sw	a5,-24(s0)
.L12:
	.loc 5 201 16 discriminator 1
	lw	a4,-24(s0)
	li	a5,63
	ble	a4,a5,.L13
.LBE3:
